...
from munk.judging.models import JudgeEvidence, JudgeExecutionSummary, JudgeScreenshotRef
...
class JudgeEvidencePack(BaseModel):
    ...
    runner_issue_summary: list[dict[str, object]] = Field(default_factory=empty_summary_items)
