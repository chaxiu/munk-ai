...
def knowledge_candidates_approve_command(
    *,
    app_id: str,
    candidate_id: str,
    ...
    try:
        ...
        handle_cli_error(command="knowledge_candidates_approve", exc=exc, json_output=json_output)
    if json_output:
    ...
    typer.echo(
        ...
        f"resolved_card_id={payload['data']['resolved_card_id']}"
    )
