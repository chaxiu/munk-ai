...
_EXPORTS = {
    ...
    "effective_config_dict": ("munk.config.layered", "effective_config_dict"),
    ...
    "read_shared_for_sync": ("munk.config.layered", "read_shared_for_sync"),
    "replace_shared_in_document": ("munk.config.layered", "replace_shared_in_document"),
    ...
    "split_flat_to_layered": ("munk.config.layered", "split_flat_to_layered"),
